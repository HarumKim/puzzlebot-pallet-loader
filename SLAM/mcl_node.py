...
class MCLNode(Node):
    ...
    def save_map(self):
        ...
        save_path = '/home/valeria/ros2_ws/src/puzzlebot_pallet_loader/puzzlebot_pallet_loader/mapa_generado.png'
        cv2.imwrite(save_path, self.map_img)
        self.get_logger().info(f'✅ Mapa guardado exitosamente en: {save_path}')
