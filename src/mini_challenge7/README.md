...
1. Compila los paquetes usando `colcon`:
   ```bash
   colcon build --packages-select mini_challenge7 puzzlebot_gazebo
...
3. En otra terminal, lanza el nodo de navegación indicando el mismo mapa:
   ```bash
   # Con Bug0:
   ros2 launch mini_challenge7 bug0_launch.py world:=obstacle_avoidance_1.world

   # Con Bug2:
   ros2 launch mini_challenge7 bug2_launch.py world:=obstacle_avoidance_1.world
   ```
